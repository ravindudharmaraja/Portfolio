        ...
        <div class="art-info-bar">
          ...
          <div class="art-info-bar-frame">
            ...
            <div class="art-header">
              ...
              <!-- avatar end -->
              <!-- name -->
              <h5 class="art-name mb-10"><a href="/home.html">Ravindu N Dharmaraja</a></h5>
              <!-- post -->
              <div class="art-sm-text">Software Engineer</div>
            </div>
            <!-- info bar header end -->
            ...
            <div id="scrollbar2" class="art-scroll-frame">
              ...
              <div class="art-table p-15-15">
                ...
                <ul>
                  <!-- country -->
                  <li>
                    <h6>Residence:</h6><span>Sri Lanka</span>
                  </li>
                  <!-- city -->
                  <li>
              ...
              <div class="art-links-frame p-15-15">
                ...
                <!-- download cv button -->
                <a href="files/cv.pdf" class="art-link" download>Download cv <i class="fas fa-download"></i></a>
